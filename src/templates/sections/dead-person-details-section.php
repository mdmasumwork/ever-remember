<section class="section-dead-person-details">
    <h4>Thank you for sharing that, and I'm truly sorry for your loss.</h4>
    <h4>To help me write something that truly captures {dead-person}, please could you tell me a bit more about them?</h4>
    <p>You can start with simple details, like:</p>
    <ul>
        <li>When and Where {dead-person} was born</li>
    ...
    <div class="field-caption">
        ...
        <p>It’s completely okay if you’re unsure what to say. Feel free to use the white answer boxes to ask for ideas or guidance whenever you need.</p>
    </div>
</section>