<section class="section-deceased-person-accomplishment">
    ...
    <div class="field-area">
        <textarea id="deceased-person-accomplishment-field"></textarea>
    ...
    <div class="field-caption">
        <button class="er-button secondary-button go-next-1">I'm not sure what to say <img src="assets/images/icons/question-mark.svg" /></button>
    </div>
</section>