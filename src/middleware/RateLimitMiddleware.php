...
class RateLimitMiddleware {
    ...
    public function handle($route) {
        $limits = [
            'content' => ['attempts' => 10, 'window' => 60],    // 20 requests per minute
            'payment' => ['attempts' => 10, 'window' => 60],    // 10 requests per minute
            'feedback' => ['attempts' => 3, 'window' => 60],    // 5 requests per minute
            ...
            'email' => ['attempts' => 10, 'window' => 60],        // 5 requests per minute
            'form_data' => ['attempts' => 15, 'window' => 60]   // 10 requests per minute
        ];
